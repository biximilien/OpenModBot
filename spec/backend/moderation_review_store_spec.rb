...
describe Backend::ModerationReviewStore do
  ...
  it "filters moderation reviews by user" do
    record_moderation_review(server_id: server_id, channel_id: 1, message_id: 1, user_id: user_id, strategy: "A",
                             action: "removed", shadow_mode: false, flagged: true)
    record_moderation_review(server_id: server_id, channel_id: 1, message_id: 2, user_id: 999, strategy: "A",
                             action: "removed", shadow_mode: false, flagged: true)
  ...
  it "finds a moderation review by message id" do
    record_moderation_review(server_id: server_id, channel_id: 1, message_id: 1234, user_id: user_id, strategy: "A",
                             action: "removed", shadow_mode: false, flagged: true)
